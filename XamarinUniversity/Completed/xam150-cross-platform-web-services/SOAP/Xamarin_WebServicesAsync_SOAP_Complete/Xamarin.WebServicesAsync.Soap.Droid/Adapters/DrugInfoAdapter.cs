...
namespace Xamarin.WebServicesAsync.Soap.Droid.Adapters
{
	public class DrugInfoAdapter : BaseAdapter<Core.Model.DrugInfo>
    {
        ...
        public override int Count { get { return DrugInformation.Count; } }

        public override Core.Model.DrugInfo this[int position] { get { return DrugInformation[position]; } }
