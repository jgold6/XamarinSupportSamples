...
namespace TheBestAppEver
{
	public class TodoViewModel : ViewModel<TodoItem>
	{
		...
		async Task refreshOffline()
		{
			...
			// TODO: Step 3d - use private fields to avoid refresh each time.
...
//			Completed = completedTasks.Result;
		...
		public async Task Refresh ()
		{
			...
			// TODO: Step 3e - move database insert to task so it's not on the UI thread.
			await Task.Run(() => Database.TodoItems.InsertAll (items, "OR REPLACE"));
			await refreshOffline ();
