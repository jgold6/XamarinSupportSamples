...
namespace com.xamarin.university.mobilenav.ios.stack {
	public class SessionsViewController : UITableViewController {
		...
		public override void ViewDidLoad ()
		{
			...
			// Example of putting a right-hand button in the navigation bar 
			// provided by a UINavigationController. In this case, using a system
			// icon, though custom images can also be used.
//			var navButton = new UIBarButtonItem(UIBarButtonSystemItem.Refresh);
//			navButton.Clicked += (sender, e) => {
//				new UIAlertView("Sample", "Sample navigation button clicked", null, "Okay").Show();
//			};
